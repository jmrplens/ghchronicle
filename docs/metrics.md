...
The thirty-four families of GitHub metrics ghchronicle collects, what each one asks the API for, and the reason each exists.
...
Every measurement ghchronicle writes from the GitHub API, its tags, its fields, and how each one is dated.
