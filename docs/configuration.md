...
The ghchronicle configuration: one YAML file, every value expandable from the environment, and what each top-level block is for.
...
repositories per `totals` sweep. And a [backfill](https://jmrp.io/docs/ghchronicle/how/backfill/) collects archived
