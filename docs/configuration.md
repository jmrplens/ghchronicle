...
The reserve is scaled per bucket; see [rate limits](https://jmrplens.github.io/ghchronicle/api/).
...
`-backfill-since`. See [backfill](https://jmrplens.github.io/ghchronicle/how/backfill/).
...
- [Targets](https://jmrplens.github.io/ghchronicle/configuration/targets/): which repositories, and the
  fork and archived defaults.
- [Cadences](https://jmrplens.github.io/ghchronicle/configuration/cadences/): the `every` block, and what
  `0` means.
- [Logging](https://jmrplens.github.io/ghchronicle/configuration/logging/): level, format and the
  rotating file.
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/): the `sinks` block, one page per
  store.
...
point per `totals` sweep after it. And a [backfill](https://jmrplens.github.io/ghchronicle/how/backfill/) collects archived
...
Source: <https://jmrplens.github.io/ghchronicle/configuration/cadences/>
...
how many there are. See [cost of a sweep](https://jmrplens.github.io/ghchronicle/api/cost/).
...
than in a metrics database. See [Loki](https://jmrplens.github.io/ghchronicle/sinks/loki/).
