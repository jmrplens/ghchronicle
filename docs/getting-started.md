...
- [Quickstart](https://jmrplens.github.io/ghchronicle/start/quickstart/): from nothing to a first sweep.
- [The token](https://jmrplens.github.io/ghchronicle/start/token/): which scope buys which family.
- [Dating a point](https://jmrplens.github.io/ghchronicle/how/dating/): the design idea everything else
  follows from.
...
2. **Create a token** at `https://github.com/settings/tokens` and export it.
    ...
    collects. The
    [token page](https://jmrplens.github.io/ghchronicle/start/token/) explains which scope buys which
...
[the backfill page](https://jmrplens.github.io/ghchronicle/how/backfill/) says what it reaches and what
it costs.

> **Keep the state file**
>
> `state_file` is what remembers where each family got to, and
> [six things live in it](https://jmrplens.github.io/ghchronicle/configuration/#state_file). Delete it and
...
- [Ways to install](https://jmrplens.github.io/ghchronicle/install/) is what turns the command above into
  something that keeps running: systemd, Docker or a scheduled Action.
- [Dating a point](https://jmrplens.github.io/ghchronicle/how/dating/) is the design idea everything else
  follows from.
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/) decides which questions you will be
  able to ask later.
- [Cost of a sweep](https://jmrplens.github.io/ghchronicle/api/cost/) is the measured price in API calls.
...
[GitHub Actions](https://jmrplens.github.io/ghchronicle/install/actions/).
