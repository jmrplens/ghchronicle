...
| -------------------------------------------------- | -------------------------------------------- | ---------------------------------------------- | ------------------------------- |
| [InfluxDB](https://jmrplens.github.io/ghchronicle/sinks/influxdb/)           | the dated history                            | "how fast were we merging in July"             | `url`, `token`, `org`, `bucket` |
| [PostgreSQL](https://jmrplens.github.io/ghchronicle/sinks/postgres/)         | the dated history, as SQL you pipe into psql | a Grafana user with a Postgres and no InfluxDB | `dialect`, `path`               |
| [Graphite](https://jmrplens.github.io/ghchronicle/sinks/graphite/)           | the dated history                            | a Graphite that is already there               | `addr`, `prefix`                |
| [Elasticsearch](https://jmrplens.github.io/ghchronicle/sinks/elasticsearch/) | the dated history, as documents              | search across everything collected             | `url`, `prefix`, `api_key`      |
| [Prometheus](https://jmrplens.github.io/ghchronicle/sinks/prometheus/)       | the current value                            | alerting, and a number on a wall               | `listen`, `path`                |
| [OpenTelemetry](https://jmrplens.github.io/ghchronicle/sinks/otlp/)          | either, depending on the backend             | an existing collector pipeline                 | `endpoint`, `raw`               |
| [Loki](https://jmrplens.github.io/ghchronicle/sinks/loki/)                   | the events, as log lines                     | "what happened, in order"                      | `url`, `labels`, `max_age`      |
| [Telegraf](https://jmrplens.github.io/ghchronicle/sinks/telegraf/)           | whatever its outputs keep                    | reaching anything Telegraf can reach           | `url`                           |
| [File and stdout](https://jmrplens.github.io/ghchronicle/sinks/file/)        | line protocol or JSON                        | a shipper you already run, and a buffer        | `path`, `format`                |
...
[state file](https://jmrplens.github.io/ghchronicle/configuration/).
...
shape [the Action](https://jmrplens.github.io/ghchronicle/install/actions/) runs in, writes every point
...
- [You want the history](https://jmrplens.github.io/ghchronicle/sinks/influxdb/): InfluxDB is the reference implementation and the dashboard is built against it. PostgreSQL, Graphite and Elasticsearch keep the same facts in their own shapes.

- [You want alerts](https://jmrplens.github.io/ghchronicle/sinks/prometheus/): Prometheus serves the current value of everything that has one. Run it alongside a history store rather than instead of one.

- [You want to read what happened](https://jmrplens.github.io/ghchronicle/sinks/loki/): Loki turns twenty-two of the measurements into log lines that read as sentences and carry every tag after them in logfmt.

- [You already have a pipeline](https://jmrplens.github.io/ghchronicle/sinks/telegraf/): Telegraf and OpenTelemetry hand the points to something that already knows where they should go.
...
makes the whole [backfill](https://jmrplens.github.io/ghchronicle/how/backfill/) design work.

The [dashboards](https://jmrplens.github.io/ghchronicle/dashboards/) are generated against this store
...
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/) compares InfluxDB with the other nine,
  and holds the write ledger every one of them shares.
- [The dashboards](https://jmrplens.github.io/ghchronicle/dashboards/) says which of the five is drawn
...
[dating a point](https://jmrplens.github.io/ghchronicle/how/dating/#the-ten-that-are-never-served).
...
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/) compares Prometheus with the other nine,
  and holds the write ledger every one of them shares.
- [The dashboards](https://jmrplens.github.io/ghchronicle/dashboards/) says which of the five is drawn
  against which store, and what a panel a store cannot answer becomes.
...
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/) compares OpenTelemetry with the other nine,
  and holds the write ledger every one of them shares.
- [The dashboards](https://jmrplens.github.io/ghchronicle/dashboards/) says which of the five is drawn
  against which store, and what a panel a store cannot answer becomes.
...
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/) compares PostgreSQL with the other nine,
  and holds the write ledger every one of them shares.
- [The dashboards](https://jmrplens.github.io/ghchronicle/dashboards/) says which of the five is drawn
  against which store, and what a panel a store cannot answer becomes.
...
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/) compares Graphite with the other nine,
  and holds the write ledger every one of them shares.
- [The dashboards](https://jmrplens.github.io/ghchronicle/dashboards/) says which of the five is drawn
  against which store, and what a panel a store cannot answer becomes.
...
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/) compares Elasticsearch with the other nine,
  and holds the write ledger every one of them shares.
- [The dashboards](https://jmrplens.github.io/ghchronicle/dashboards/) says which of the five is drawn
  against which store, and what a panel a store cannot answer becomes.
...
Source: <https://jmrplens.github.io/ghchronicle/sinks/loki/>
...
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/) compares Loki with the other nine,
  and holds the write ledger every one of them shares.
- [The dashboards](https://jmrplens.github.io/ghchronicle/dashboards/) says which of the five is drawn
  against which store, and what a panel a store cannot answer becomes.
...
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/) compares Telegraf with the other nine,
  and holds the write ledger every one of them shares.
- [The dashboards](https://jmrplens.github.io/ghchronicle/dashboards/) says which of the five is drawn
  against which store, and what a panel a store cannot answer becomes.
...
- [Choosing a store](https://jmrplens.github.io/ghchronicle/sinks/) compares the file sink with the other nine,
  and holds the write ledger every one of them shares.
- [The dashboards](https://jmrplens.github.io/ghchronicle/dashboards/) says which of the five is drawn
  against which store, and what a panel a store cannot answer becomes.
