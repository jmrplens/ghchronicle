...
A [backfill](https://jmrplens.github.io/ghchronicle/how/backfill/) is a different intention and says so:
...
[The card](https://jmrplens.github.io/ghchronicle/card/) has the layouts and the fields.

## Where the rest lives

Everything that is not in that table is a configuration key, not a flag:
[the file](https://jmrplens.github.io/ghchronicle/configuration/) is the map of them.
