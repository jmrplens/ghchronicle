...
Source: <https://jmrplens.github.io/ghchronicle/how/>
...
is the subject of [dating a point](https://jmrplens.github.io/ghchronicle/how/dating/).
...
default, for the reason set out in [targets](https://jmrplens.github.io/ghchronicle/configuration/targets/).
...
being spent to the last call. See [rate limits](https://jmrplens.github.io/ghchronicle/api/).

A [backfill](https://jmrplens.github.io/ghchronicle/how/backfill/) is the opposite intention: it waits for
...
| Loki                                          | recent events only          | Loki refuses an entry too far behind the newest in its stream. See [Loki](https://jmrplens.github.io/ghchronicle/sinks/loki/) |
...
See [cadences](https://jmrplens.github.io/ghchronicle/configuration/cadences/) for why `default` and
