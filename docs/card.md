...
| `-card-layout <name>`             | One of the ten [layouts](https://jmrplens.github.io/ghchronicle/card/layouts/)      |
...
[calling it from a program](https://jmrplens.github.io/ghchronicle/reference/subprocess/).
...
- [The card](https://jmrplens.github.io/ghchronicle/card/) is what draws these, and how to put one in a
  README.
- [Calling it from a program](https://jmrplens.github.io/ghchronicle/reference/subprocess/) is the
