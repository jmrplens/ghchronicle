...
Source: <https://jmrplens.github.io/ghchronicle/reference/subprocess/>
...
[Measurements](https://jmrplens.github.io/ghchronicle/collectors/measurements/).
...
- **-card**
  ...
  [the card](https://jmrplens.github.io/ghchronicle/card/).
...
GraphQL point per repository for commits and one to two for issues. [Cost of a sweep](https://jmrplens.github.io/ghchronicle/api/cost/) has the measured
...
> spawning it: run it as a service and give it a [sink](https://jmrplens.github.io/ghchronicle/sinks/).
