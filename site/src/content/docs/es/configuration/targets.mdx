...
- **El tráfico de un fork es casi siempre cero.** GitHub informa de visitas y
  ...
  nada.
- **Un repositorio archivado ya no da trabajo.** Sus estrellas, sus forks y
  sus watchers todavía pueden moverse, y esos se leen de todos modos, como se
  explica abajo. Nada más puede, y recogerlo gasta el presupuesto en filas que
  ya no se mueven.
...
cadencia, así que la tabla _Repositories archived_ existe desde la primera
