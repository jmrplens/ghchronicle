...
Treinta y cuatro familias, noventa y dos medidas. Esta página es para qué sirve
...
280 llamadas para un repositorio con 28.000 estrellas. Desde julio de 2026
GitHub sirve la lista solo a los administradores y colaboradores del
repositorio, así que la curva se dibuja solo donde el token tiene ese acceso,
que siempre tiene en los repositorios de la propia cuenta y en los de una
organización que la cuenta administra; de cualquier otro se recoge el número de
estrellas y no la curva (ver [lo que GitHub no da](/ghchronicle/es/api/limits/)).
