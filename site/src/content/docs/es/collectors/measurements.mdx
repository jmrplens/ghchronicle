...
son una sola forma, y `org` ha desaparecido porque era `owner` con la mitad
personal en blanco.

Es un cambio incompatible con lo ya almacenado. Las filas escritas por una
versión anterior conservan las etiquetas viejas, las nuevas llevan las nuevas, y
las dos no se juntan: en InfluxDB el conjunto de etiquetas forma parte de la
identidad de un punto, así que un colector actualizado abre una segunda serie
por repositorio en lugar de continuar la primera. No se pierde ni se reescribe
nada, pero un panel que cruce la actualización verá dos series a medio poblar.
Recrear la base de datos, o aceptar la costura y dejar que las filas viejas
salgan del rango que consultas, son las dos salidas; no hay migración, porque
una etiqueta no se puede renombrar in situ.
