...
repositorio archivado, en el Overview y en _Every repository, ever_, y
...
siguen saliendo de `gh_repo`, que una pasada escribe cada hora donde `totals`
escribe cada doce. No recibe `gh_repo_policy`. Esa consulta
