...
sus repositorios están hechos. Se borra cuando el recorrido llega al final, así
que un punto de control que existe es un recorrido que no llegó.
...
al recorrido: la API que lee, los objetivos, las familias activas y el límite de
fecha tal y como se escribió. Si algo de eso cambió entre la parada y la vuelta,
la lista de repositorios que no hay que volver a recorrer significa otra cosa, y
la ejecución se para y nombra el ajuste que cambió.
