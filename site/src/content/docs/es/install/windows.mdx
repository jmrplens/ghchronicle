...
searchTitle: Instalar ghchronicle en Windows
compactTables:
...
2. Comprueba el propio fichero de sumas, si tienes
   ...
   que diga el fichero. La orden es la misma que imprimen las notas de la
   release, y la misma que ejecuta quien lea la página de Linux o la de macOS.
...
Responde con una línea: el número de la versión, y después el commit y la
fecha de compilación de esa versión.
