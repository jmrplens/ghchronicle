...
description: Una página por sistema operativo, cuatro maneras de poner el binario en marcha, y para qué sirve cada una.
---
...
cuatro opciones.
Las dos primeras necesitan una máquina propia; las dos últimas no, y las
páginas por sistema de arriba van de las dos primeras.
