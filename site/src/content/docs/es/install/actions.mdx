...
| `card-width`      | `""`                     | Ancho de la tarjeta en píxeles. Vacío dibuja el diseño con su propio ancho; cada uno dibuja entre su mínimo y 1200. Solo `activity-heatmap` se gasta el sitio en datos, un año entero del calendario a unas 900 |
