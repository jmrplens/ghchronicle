...
pasada propia. Eso vale tal cual cuando la Action escribe su propia
configuración, porque entonces cada uso tiene su propio fichero de estado. Con un
fichero en `config`, da a cada paso su propio fichero con un `state_file`
distinto: una segunda pasada que lee el estado de la primera recibe "no
modificado" para todo y dibuja una tarjeta de ceros.
