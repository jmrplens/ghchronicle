...
<Card name="wide-banner" alt="El diseño wide-banner: un banner ancho y bajo con el login a la izquierda, números repartidos y un sparkline detrás" animated />
...
<Card name="sparkline-hero" alt="El diseño sparkline-hero: un sparkline de contribuciones grande que llena la tarjeta con tres números superpuestos" animated />
...
<Card name="animated-counters" alt="El diseño animated-counters: una rejilla de números grandes sobre un sparkline de contribuciones" animated />
