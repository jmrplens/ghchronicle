...
cifras de ocho dígitos o más se lleva una columna más ancha y le deja a la
rejilla una o dos semanas menos, que es la misma regla vista del otro lado. Las
semanas aparecen desde la izquierda, y la ola cruza la rejilla en 0,22 s tenga
las semanas que tenga, así que el calendario se llena como una ola de la misma
duración a cualquier ancho.
