...
Los imprime con los campos que muestra cada uno por omisión. Cada tarjeta de
abajo se muestra en la paleta en la que está esta página, clara u oscura; todos
los diseños dibujan las dos, y `auto` mete ambas en un fichero.
