---
title: Resumen
description: "La tarjeta de ghchronicle: un SVG autocontenido de la actividad en GitHub para un README de perfil, dibujado con los mismos puntos que reciben las bases de datos."
searchTitle: Una tarjeta SVG de tu actividad en GitHub
compactTables:
  - "-card-motion"
  - "-card-speed"
---
...
ghchronicle puede dibujar una tarjeta SVG autocontenida con la actividad en GitHub de una cuenta, para un README de perfil, a partir de los puntos que ya recoge.
...
que es lo que le permite saltarse los recorridos únicos de la lista de
stargazers y del historial diario de estrellas: lo que el estado recuerda
abarata la pasada, nunca encoge la tarjeta.
...
<Tabs syncKey="card-theme">
  ...
  <TabItem label="auto (por omisión)">
