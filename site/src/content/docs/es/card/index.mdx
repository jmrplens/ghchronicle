...
La animación, en los layouts que la tienen, es CSS dentro del SVG, y nunca hay
...
<Card name="animated-counters-loop" alt="El layout animated-counters en bucle: las cifras cuentan, se detienen y vuelven a contar" />
