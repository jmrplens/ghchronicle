...
- `terminal`, cuyo cursor parpadea en el prompt. Las cifras se siguen tecleando
  una sola vez.
...
<Card name="terminal" animated loop alt="El diseño terminal reproducido una vez: una ventana de terminal cuyas líneas de salida tienen cada una un número que se teclea solo, con un cursor de bloque que parpadea en el prompt de abajo, y la página también puede reproducirlo en bucle, donde el tecleo sigue ocurriendo una vez y solo el cursor sigue parpadeando" />
