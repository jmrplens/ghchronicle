...
lleve corriendo tanto tiempo. Desde julio de 2026 GitHub solo sirve esa lista
a los
[administradores y colaboradores](https://docs.github.com/es/rest/activity/starring#new-access-restrictions)
del repositorio, así que un repositorio al que el token no tiene ese acceso no
tiene estrellas fechadas: falta en todos los paneles que se dibujan con ellas,
y su número sigue apareciendo en Stars by repository. Los forks en el tiempo se
dibujan como la curva de estrellas, desde `gh_fork`, cada fork con la fecha en
que se hizo, así que también se remontan
