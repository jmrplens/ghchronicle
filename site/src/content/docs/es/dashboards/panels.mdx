...
que corrieron en el rango, cuántos repositorios se les preguntaron, cuántos de
ellos no pudieron recoger y cuántas filas produjeron; una familia sin fila ahí
no corrió en absoluto. El segundo es una fila por cada repositorio que un
colector no pudo recoger, el más reciente primero, con lo que respondió GitHub.
