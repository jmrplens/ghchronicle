---
title: Qué muestran
description: Las diecisiete secciones y sus ciento cincuenta y dos paneles, una captura de cada una, y qué cambia cuando el almacén no puede responder.
---
...
Fusionados, tiempo hasta fusionar, tiempo hasta la primera revisión, issues
cerrados, tiempo hasta cerrar y líneas cambiadas como un grupo de seis valores;
...
<Aside
  type="caution" title="Cuidado al leer el tiempo hasta la primera revisión" >
  ...
  segundos de los bots. Medido, nueve de cada diez pull requests tuvieron una
...
corto: en un repositorio de aquí, por un factor de cincuenta y seis.
...
la lista que factura y la que se recorre no son la misma.
...
del dashboard no llega a ese panel: un fijado se llama owner/name, o es un
gist, y la variable no guarda ninguna de las dos cosas.
