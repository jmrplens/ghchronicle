...
<Aside
  ...
  sobre un No data se leía como que no se había revisado nada: medido aquí, 706
  de 829 pull requests en quince días tuvieron una primera revisión y ninguna la
  tuvo de otra persona. Nueve de cada diez pull requests tuvieron una
