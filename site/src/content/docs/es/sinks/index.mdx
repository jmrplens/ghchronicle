...
description: "Dónde guardar las métricas de GitHub: once almacenes, qué puede y qué no puede responder cada uno, y la propiedad que decide entre ellos."
searchTitle: Dónde guardar métricas de GitHub
compactTables:
  - Almacén
---
...
Once destinos, y usar más de uno es lo normal. Todos envían por push: la
...
| [PostgreSQL](/ghchronicle/es/sinks/postgres/)         | la historia fechada, en una base a la que conecta | quien usa Grafana con un Postgres y sin InfluxDB | `dsn`, `batch`                  |
| [PostgreSQL, a fichero](/ghchronicle/es/sinks/postgres/) | las mismas tablas, como SQL que pasas a psql | una carga que ocurre después, o en otro sitio    | `dialect`, `path`               |
