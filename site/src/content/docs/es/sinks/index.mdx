...
`filtered` es lo que el destino no escribió, y la pasada imprime el total de
cada destino una vez al final. Las líneas que un almacén no supo analizar
tampoco cuentan como escritas; esas llevan su propia línea de aviso.
