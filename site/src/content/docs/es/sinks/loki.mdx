...
Loki cuya dirección termine en `/loki/api/v1/push`: el datasource se crea a
partir de ella. Uno que escriba en otro sitio lo dice y toma un
`grafana.datasource.loki_uid` en su lugar.
