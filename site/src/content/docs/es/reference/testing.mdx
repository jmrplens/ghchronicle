...
cualquier otro toma prestado el de hello-world. Cada diseño sale dos veces,
`card-<diseño>.svg` en la paleta clara y `card-<diseño>_dark.svg` en la oscura,
que es lo que leen el `ThemeImage` del sitio y el `<picture>` del README.
