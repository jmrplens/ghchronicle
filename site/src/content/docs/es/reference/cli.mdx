...
description: "La línea de órdenes de ghchronicle: las opciones, qué hace cada una y cuáles imprimen algo y salen."
searchTitle: Opciones de línea de órdenes de ghchronicle
defaultColumns:
  - table: Opción
    default: Por omisión
---
...
`-version`, `-groups`, `-card-layouts`, `-list` y `-backfill-status` responden
...
[punto de control del relleno](/ghchronicle/es/how/backfill/#ver-hasta-dónde-ha-llegado)
e imprime hasta dónde ha llegado ese recorrido; no le pregunta nada a GitHub,
