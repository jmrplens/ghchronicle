...
>
  ...
  reshapes itself around your configuration. PostgreSQL and Elasticsearch behave
  the same way; Prometheus and Graphite have no schema to miss, so the same
  panels there read No data instead.
</Aside>
