...
description: "The ghchronicle command line: the flags, what each one does, and which of them print something and exit."
searchTitle: ghchronicle command-line flags
defaultColumns:
  - table: Flag
    default: Default
---
...
`-version`, `-groups`, `-card-layouts`, `-list` and `-backfill-status` answer
...
[backfill checkpoint](/ghchronicle/how/backfill/#seeing-how-far-it-has-got)
