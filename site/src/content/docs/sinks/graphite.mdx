---
title: Graphite
description: "Sending GitHub metrics to Graphite: the plaintext protocol over TCP, and the exact metric path, which is the dashboard's contract."
searchTitle: Send GitHub metrics to Graphite
---
