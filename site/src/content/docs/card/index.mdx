---
title: Overview
description: "The ghchronicle card: a self-contained SVG of GitHub activity for a profile README, drawn from the same points the databases receive."
searchTitle: An SVG card of your GitHub activity
compactTables:
  - "-card-motion"
  - "-card-speed"
---
...
ghchronicle can draw a self-contained SVG card of an account's GitHub activity for a profile README, from the points it already collects.
