...
<Card name="wide-banner" alt="The wide-banner layout: a wide, short banner with the login on the left, numbers spread across and a sparkline behind them" animated />
...
<Card name="sparkline-hero" alt="The sparkline-hero layout: a large contribution sparkline filling the card with three numbers overlaid" animated />
...
<Card name="animated-counters" alt="The animated-counters layout: a grid of large numbers over a contribution sparkline" animated />
