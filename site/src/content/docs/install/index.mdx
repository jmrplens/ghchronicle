...
description: "Ways to install ghchronicle: a page per operating system, five ways to get the binary running, and what each one is good for."
searchTitle: Install ghchronicle
compactTables:
  - Command
---
