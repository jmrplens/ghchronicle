---
title: Importing
description: Five generated Grafana dashboards for GitHub metrics, one per store, and how to import each of them.
searchTitle: Import Grafana dashboards for GitHub metrics
---
...
<Aside type="caution" title="A password from the machine is not copied">
...
<Aside type="note" title="What the token has to be allowed to do">
