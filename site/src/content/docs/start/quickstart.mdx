---
title: Quickstart
description: Install ghchronicle, point it at a database and run a first sweep of a GitHub account, and what that first sweep does that later ones do not.
searchTitle: "ghchronicle quickstart: a first sweep"
---
...
<Aside type="caution" title="Keep the state file">
  ...
  [seven things live in it](/ghchronicle/configuration/#state_file). Delete it
